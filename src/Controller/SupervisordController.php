...
use App\Services\Supervisord\XmlRpcService;
 ...
 */
class SupervisordController extends AbstractController
{
    ...
    public function __construct(XmlRpcService $supervisor)
    {
    ...
    {
        $processes                  = $this->supervisor->listProcess();
        $processList                = [];
    ...
    {
        $processList    = $this->supervisor->listProcess();
        $processData    = null;
    ...
    public function startprocessAction($processname)
    {
        ...
        try {
            $this->supervisor->startProcess($workerName);
        } catch(\Exception $e) {
            $response['code'] = 'KO';
    ...
    public function startgroupAction($processgroup)
    {
        ...
        try {
            $this->supervisor->startGroup($processgroup);
            $response['code'] = 'OK';
        } catch(\Exception $e) {
            $response['code'] = 'KO';
            $response['data'] = $e->getMessage();
    ...
    public function stopprocessAction($processname)
    {
        ...
        $workerName         = ($processData['name'] != $processData['group']) ? $processData['group'].':'.$processData['name'] : $processData['name'];
        $this->supervisor->stopProcess($workerName);
    ...
    public function stopgroupAction($processgroup)
    {
        ...
        $this->supervisor->stopGroup($processgroup);
    ...
    public function refreshAction($workername)
    {
        ...
        return $this->render('App:Monitoring/Supervisord:tail.html.twig', [
